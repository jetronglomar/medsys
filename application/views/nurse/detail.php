                                                ...
                                                <?php foreach($RecentEngagement as $row){ ?>
                                                    <div class="animated flipInY col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="tile-stats">
                                                                <a href="<?php echo base_url()?>nurse/enDetails/<?php echo $row->Id ?>">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo base_url(); ?>nurse/card/<?php echo $PatientDetails['Id']; ?>" class="btn btn-success btn-md pull-right" target="_blank"><i class="fa fa-print"></i> Patient Card</a>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
