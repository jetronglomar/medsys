...
?>
  ...
  <body class="nav-md">
    ...
    <!-- Chart.js -->
    <script src="<?php echo base_url();?>resources/vendors/Chart.js/dist/Chart.min.js"></script>
    <!-- gauge.js -->
    <script src="<?php echo base_url();?>resources/vendors/gauge.js/dist/gauge.min.js"></script>
    ...
    <!-- Skycons -->
    <script src="<?php echo base_url();?>resources/vendors/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="<?php echo base_url();?>resources/vendors/Flot/jquery.flot.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/Flot/jquery.flot.pie.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/Flot/jquery.flot.time.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/Flot/jquery.flot.stack.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="<?php echo base_url();?>resources/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="<?php echo base_url();?>resources/vendors/DateJS/build/date.js"></script>
    <!-- JQVMap -->
    <script src="<?php echo base_url();?>resources/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="<?php echo base_url();?>resources/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
