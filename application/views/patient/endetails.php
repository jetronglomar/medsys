      ...
      ?>
        ...
        ?>
            ...
            <div class="right_col" role="main">
                ...
                <form id="enDetailsForm" action="<?php echo base_url();?>patient/saveEnDetails/0" class="form-horizontal form-label-left"
                    method="post">
                    <div class="row">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12" hidden>
                                            ...
                                            <input id="PhoneNumber" type="text" value="<?php if($EngagementDetails['PatientType'] == 1){ echo 'Outpatient'; } else{ echo 'Inpatient'; } ?>"
                                                name="PhoneNumber" class="optional form-control col-md-7 col-xs-12" required="required"
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input value="<?php if($EngagementDetailsFinal['Height']!=null) echo $EngagementDetailsFinal['Height']; ?>" id="Height" type="text"
                                                    name="Height" class="form-control col-md-7 col-xs-12" required="required"
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input value="<?php if($EngagementDetailsFinal['Pulse']!=null) echo $EngagementDetailsFinal['Pulse']; ?>" id="Pulse" type="number"
                                                    name="Pulse" class="optional form-control col-md-7 col-xs-12" required="required"
                                        ...
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input value="<?php if($EngagementDetailsFinal['Weight']!=null) echo $EngagementDetailsFinal['Weight']; ?>" id="Weight" type="number"
                                                    name="Weight" class="optional form-control col-md-7 col-xs-12" required="required"
                                                    placeholder="Enter in kg">
                                            </div>

                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <label for="occupation">Respiratory Rate (/min)</label>
                                                <input value="<?php if($EngagementDetailsFinal['Respiratory']!=null) echo $EngagementDetailsFinal['Respiratory']; ?>" id="Respiratory"
                                                    type="number" name="Respiratory" class="optional form-control col-md-7 col-xs-12"
                                                    required="required" placeholder="Enter /min">
                                            </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-2 col-sm-6 col-xs-12">
                                                ...
                                                <input value="<?php if($EngagementDetailsFinal['BPNum']!=null) echo $EngagementDetailsFinal['BPNum']; ?>" id="BPNum" type="number"
                                                    name="BPNum" class="optional form-control col-md-6 col-sm-6 col-xs-6 form-group "
                                            ...
                                            <div class="col-md-2 col-sm-6 col-xs-12">
                                                <label for="occupation">&nbsp;</label>
                                                <input value="<?php if($EngagementDetailsFinal['BPDen']!=null) echo $EngagementDetailsFinal['BPDen']; ?>" id="BPDen" type="number"
                                                    name="BPDen" class="optional form-control col-md-6 col-sm-6 col-xs-6 form-group "
                                                    required="required" placeholder="0">
                                            </div>
                                        </div>
                                        ...
                                        <div id="doctorForm">
                                                            ...
                                                            <div class="item form-group">
                                                                <div class="col-md-10 col-sm-10 col-xs-12">
                                                                    <select class="doctorSelect form-control col-md-12 col-sm-12 col-xs-12" style="width:100% !important" name="doctor[]">
                                                                        <option value="<?php echo $row->DoctorId; ?>" selected> <?php echo $this->database_model->getDoctorName($row->DoctorId); ?> </option>
                                                                    </select>
                                                                    <!-- <textarea class="form-control" placeholder="" readonly><?php echo $EngagementDetailsFinal['Medicine']; ?></textarea> -->
                                                                </div>
                                            ...
                                            <?php 
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="btnholder col-md-2 col-sm-12 col-xs-12">
                                                                    <button id="RemoveDoctor" class="btn btn-danger btn-md pull-right" onClick="$(this).parent().parent().remove();">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_content">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input style="margin:auto; display:block" id="saveEnDetails" type="submit" class="btn btn-primary" value="Update Record -> Proceed to Doctor"
                                        />
                                    </div>
