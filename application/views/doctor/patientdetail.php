    ...
    correctLevel : QRCode.CorrectLevel.H
                      ...
                      <div class="x_content">
                                                ...
                                                <?php foreach($RecentEngagement as $row){ ?>
                                                    <div class="animated flipInY col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="tile-stats">
                                                                <a href="<?php echo base_url()?>doctor/enDetails/<?php echo $row->Id ?>" target="_blank">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo base_url(); ?>doctor/engagement/<?php echo $PatientDetails['Id']; ?>"><u>View All</u></a>
                        </div>
                  </div>
              </div>
          </div>
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?php echo base_url();?>patient/savePatient/<?php echo $PatientDetails['Id']; ?>" class="form-horizontal form-label-left" novalidate="" method="post">
                      ...
                      <div class="col-md-6 col-md-offset-3">
                          <a href="<?php echo base_url() ?>doctor" class="btn btn-primary">Get Back</a>
                        </div>
