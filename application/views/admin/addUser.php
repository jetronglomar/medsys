                    ...
                    <form action="<?php echo base_url();?>patient/savePatient/0" class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="item form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input id="Name" type="text" name="Name" class="optional form-control col-md-7 col-xs-12" required="required" placeholder="Enter Name">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input id="EmailAddress" type="text" name="EmailAddress" class="optional form-control col-md-7 col-xs-12" required="required" placeholder="Enter Email Address">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input id="Password" type="text" name="Password" class="optional form-control col-md-7 col-xs-12" required="required" placeholder="Enter Password">
                            </div>
                        </div>

                        <div class="item form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <label for="occupation">Confirm Password<span class="required">*</span></label>
                                <input id="ConfirmPassword" type="text" name="ConfirmPassword" class="optional form-control col-md-7 col-xs-12" required="required" placeholder="Enter Confirm Password">
                            </div>
                        </div>
