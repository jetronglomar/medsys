              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo base_url(); ?>admin/addUser" class="btn btn-primary btn-md pull-right"> <i class="fa fa-plus"></i> User</a>
                  </div>
                  <div class="x_content">
                        ...
                        <?php 
                          foreach($User as $row){
                            echo "<tr>";
                              ...
                              echo "<td>";
                              echo "<a href='".base_url()."admin/editUser/".$row->Id."'  class='btn btn-warning btn-xs' data-toggle='tooltip' title='Edit'><i class='fa fa-edit'></i></a>";
                              if($row->Status == 1){
                                echo "<a href='".base_url()."admin/toggleStatusUser/0/".$row->Id."'  class='btn btn-danger btn-xs' data-toggle='tooltip' title='Deactivate'><i class='fa fa-close'> </i></a>";
                              }
                              else{
                                echo "<a href='".base_url()."admin/toggleStatusUser/1/".$row->Id."'  class='btn btn-success btn-xs' data-toggle='tooltip' title='Activate'><i class='fa fa-check'></i></a>";
                              }
                              echo "</td>";
