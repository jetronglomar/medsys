...
--
-- Host: localhost
-- Generation Time: Jul 19, 2019 at 01:16 PM
...
--
-- Table structure for table `R_ChiefComplaint`
--

CREATE TABLE `R_ChiefComplaint` (
  `Id` int(11) NOT NULL,
...
--
-- Dumping data for table `R_ChiefComplaint`
--

INSERT INTO `R_ChiefComplaint` (`Id`, `Description`, `ActiveStatus`) VALUES
(1, 'Headache', 1);
...
INSERT INTO `R_City` (`id`, `psgcCode`, `citymunDesc`, `regDesc`, `provCode`, `citymunCode`) VALUES
...
INSERT INTO `R_Countries` (`id`, `country_code`, `country_name`) VALUES
(1, 'AF', 'Afghanistan'),
(2, 'AL', 'Albania'),
(3, 'DZ', 'Algeria'),
(4, 'DS', 'American Samoa'),
...
--
-- Table structure for table `R_Disposition`
--

CREATE TABLE `R_Disposition` (
  `Id` int(11) NOT NULL,
...
--
-- Dumping data for table `R_Disposition`
--

INSERT INTO `R_Disposition` (`Id`, `Description`, `ActiveStatus`) VALUES
(1, 'Fit to Work', 1);

-- --------------------------------------------------------

--
-- Table structure for table `R_Doctor`
--

CREATE TABLE `R_Doctor` (
  `Id` int(11) NOT NULL,
...
--
-- Dumping data for table `R_Doctor`
--

INSERT INTO `R_Doctor` (`Id`, `FirstName`, `MiddleName`, `LastName`, `SpecializationId`, `ContactNumber`, `ActiveStatus`, `UserId`) VALUES
(1, 'Jovie', '', 'Bandal', 1, '0926738723', 1, 2);

-- --------------------------------------------------------

--
-- Table structure for table `R_LaboratoryCategory`
--

CREATE TABLE `R_LaboratoryCategory` (
  `Id` int(11) NOT NULL,
...
--
-- Dumping data for table `R_LaboratoryCategory`
--

INSERT INTO `R_LaboratoryCategory` (`Id`, `Description`, `Status`) VALUES
(1, 'X-RAY', 1),
(2, 'ULTRA SOUND', 1);
...
--
-- Dumping data for table `R_Medicine`
--

INSERT INTO `R_Medicine` (`Id`, `Description`, `ActiveStatus`) VALUES
...
--
-- Table structure for table `R_Patient`
--
...
--
-- Dumping data for table `R_Patient`
--

INSERT INTO `R_Patient` (`Id`, `FirstName`, `MiddleName`, `LastName`, `QR`, `Photo`, `Birthday`, `Gender`, `Address1`, `Address2`, `CityVillage`, `StateProvince`, `Country`, `PostalCode`, `PhoneNumber`, `CellPhoneNumber`, `Status`) VALUES
(1, 'Jet Ronrick', 'Taman', 'Glomar', 'fBQ7PxuwEqg1smhjJMicONaHS3o258y49RUWAYGVC6belITdr0', NULL, '1995-05-07', 1, 'Unit 5 Purok 8 Adarna Ext. Brgy. Commonwealth Quezon City', '', 1367, 68, 174, 1211, '09276618696', '12', 1),
(2, 'Jovie', '', 'Bandal', 'ES32r9KcQLJCRA5qzY4Pw1uDBTXdv6UGbl8sjZpf7teWkVIHoM', NULL, '2019-07-23', 2, 'test', 'test', 1, 1, 174, 1211, '123', '123', 1),
(3, 'John Edcel', 'Tamang', 'Zenarosa', 'hZ8zqtDaiET5upKS3LVrAGgB6YMk0NnlPcHJWx2XdCO9IowF4j', NULL, '1999-05-07', 1, 'Unit 5 Purok 8 Adarna Ext. Brgy. Commonwealth Quezon City', 'sample', 208, 67, 174, 1211, '9276618696', 'test', 1);

-- --------------------------------------------------------

--
-- Table structure for table `R_Province`
--
...
--
-- Dumping data for table `R_Province`
--

INSERT INTO `R_Province` (`id`, `psgcCode`, `provDesc`, `regCode`, `provCode`) VALUES
...
--
-- Table structure for table `R_Purpose`
--

CREATE TABLE `R_Purpose` (
  `Id` int(11) NOT NULL,
...
--
-- Dumping data for table `R_Purpose`
--

INSERT INTO `R_Purpose` (`Id`, `Description`, `Status`) VALUES
(1, 'BP Monitoring', 1),
(2, 'Facility Visit', 1);
...
INSERT INTO `R_Role` (`Id`, `Description`) VALUES
(1, 'Head Nurse'),
(2, 'Doctor'),
(3, 'Nurse'),
(4, 'Pharmacist');
...
INSERT INTO `R_Room` (`Id`, `Description`, `ActiveStatus`) VALUES
(1, 'ER', 1),
(2, '101', 1);
...
--
-- Table structure for table `R_Specialization`
--

CREATE TABLE `R_Specialization` (
  `Id` int(11) NOT NULL,
...
--
-- Dumping data for table `R_Specialization`
--

INSERT INTO `R_Specialization` (`Id`, `Name`, `Description`, `ActiveStatus`) VALUES
(1, 'Allergists/Immunologists', 'They treat immune system disorders such as asthma, eczema, food allergies, insect sting allergies, and some autoimmune diseas', 1),
(2, 'Anesthesiologists', 'These doctors give you drugs to numb your pain or to put you under during surgery, childbirth, or other procedures. They monitor your vital signs while you’re under anesthesia.', 1);
...
INSERT INTO `R_User` (`Id`, `EmailAddress`, `Password`, `ActiveStatus`, `RoleId`) VALUES
(1, 'jetronglomar@gmail.com', '123456', 1, 1),
(2, 'joviebandal@gmail.com', '123456', 1, 2),
(3, 'johndoe@gmail.com', '123456', 1, 3),
(4, 'lorem@gmail.com', '123456', 1, 4);

-- --------------------------------------------------------

--
-- Table structure for table `T_Allergies`
--

CREATE TABLE `T_Allergies` (
  `Id` int(11) NOT NULL,
  `Description` varchar(500) NOT NULL,
  `EngagementDetailsId` int(11) NOT NULL,
  `ActiveStatus` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `T_Allergies`
--

INSERT INTO `T_Allergies` (`Id`, `Description`, `EngagementDetailsId`, `ActiveStatus`) VALUES
(1, 'allergy 1', 12, 1),
(2, 'allergy 2', 12, 1),
(3, 'allergy 1', 13, 1),
(4, 'allergy 2', 13, 1),
...
--
-- Table structure for table `T_Engagement`
--

CREATE TABLE `T_Engagement` (
  `Id` int(11) NOT NULL,
  `PatientId` int(11) NOT NULL,
  `PurposeId` int(11) NOT NULL,
  `DateOfEngagement` datetime NOT NULL,
  `PatientType` int(11) DEFAULT NULL,
  `RoomId` int(11) NOT NULL,
  `IsEnded` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `T_Engagement`
--

INSERT INTO `T_Engagement` (`Id`, `PatientId`, `PurposeId`, `DateOfEngagement`, `PatientType`, `RoomId`, `IsEnded`) VALUES
(1, 3, 1, '2019-07-17 07:25:27', 2, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `T_EngagementDetails`
--

CREATE TABLE `T_EngagementDetails` (
  `Id` int(11) NOT NULL,
  ...
  `BMI` double NOT NULL,
  `BPNum` double NOT NULL,
  `BPDen` double NOT NULL,
  `chiefComplaint` int(11) NOT NULL,
  `chiefComplaintRemarks` varchar(50000) NOT NULL,
  `DateCreated` date DEFAULT NULL,
  `DateModified` date DEFAULT NULL,
  `ModifiedBy` int(11) NOT NULL,
  `EngagementId` int(11) NOT NULL,
  `PresentIllnessHistory` varchar(2500) NOT NULL,
  `CurrentMedicine` varchar(2500) NOT NULL,
  `SystemsReview` varchar(2500) NOT NULL,
  `Medicine` varchar(2500) NOT NULL,
  `Tests` varchar(2500) NOT NULL,
  `Referrals` varchar(2500) NOT NULL,
...
--
-- Dumping data for table `T_EngagementDetails`
--

INSERT INTO `T_EngagementDetails` (`Id`, `Height`, `Pulse`, `Weight`, `Respiratory`, `BMI`, `BPNum`, `BPDen`, `chiefComplaint`, `chiefComplaintRemarks`, `DateCreated`, `DateModified`, `ModifiedBy`, `EngagementId`, `PresentIllnessHistory`, `CurrentMedicine`, `SystemsReview`, `Medicine`, `Tests`, `Referrals`, `DispositionId`, `FollowUpDate`, `DoctorId`, `EngagementStatus`, `DateEnded`) VALUES
(1, 1, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(2, 1, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(3, 2, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(4, 1, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(5, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(6, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(7, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(8, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(9, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(10, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(11, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(12, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(13, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(14, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(15, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-17', 1, 1, '', '', '', '', '', '', 0, '0000-00-00', 0, 1, '0000-00-00'),
(16, 12, 1, 1, 1, 1, 1, 1, 1, 'test', '2019-07-17', '2019-07-18', 1, 1, '', '', '', '', '', '', 0, '2019-07-18', 1, 1, '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `T_EngagementDetailsDoctor`
--

CREATE TABLE `T_EngagementDetailsDoctor` (
  `Id` int(11) NOT NULL,
  `EngagementDetailsId` int(11) NOT NULL,
  `DoctorId` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `T_EngagementDetailsDoctor`
--

INSERT INTO `T_EngagementDetailsDoctor` (`Id`, `EngagementDetailsId`, `DoctorId`) VALUES
(1, 1, 1),
(2, 5, 1),
(3, 6, 1),
(4, 13, 1),
...
--
-- Table structure for table `T_EngagementMedicine`
--

CREATE TABLE `T_EngagementMedicine` (
  `Id` int(11) NOT NULL,
  `EngagementDetailsId` int(11) NOT NULL,
  `DoctorId` int(11) NOT NULL,
...
--
-- Dumping data for table `T_EngagementMedicine`
--

INSERT INTO `T_EngagementMedicine` (`Id`, `EngagementDetailsId`, `DoctorId`, `MedicineId`, `Qty`, `DateStart`, `DateEnd`, `Status`, `DateApproved`) VALUES
(4, 16, 1, 1, 13, '2019-07-25 00:00:00', '2019-07-31 23:59:00', 2, '2019-07-18 15:33:00'),
(5, 16, 1, 2, 14, '2019-07-17 00:00:00', '2019-07-17 23:59:00', 2, '0000-00-00 00:00:00'),
(6, 16, 1, 1, 13, '2019-07-17 00:00:00', '2019-07-25 23:59:00', 2, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `T_LaboratoryResult`
--

CREATE TABLE `T_LaboratoryResult` (
  `Id` int(11) NOT NULL,
  `TestDate` date DEFAULT NULL,
  `ResultDate` date DEFAULT NULL,
  `RequestedBy` int(11) NOT NULL,
  `Findings` varchar(10000) DEFAULT NULL,
  `Attachment` text,
  `PatientId` int(11) NOT NULL,
...
--
-- Dumping data for table `T_LaboratoryResult`
--

INSERT INTO `T_LaboratoryResult` (`Id`, `TestDate`, `ResultDate`, `RequestedBy`, `Findings`, `Attachment`, `PatientId`, `CategoryId`, `ExecutedBy`) VALUES
(1, '2019-06-09', '2019-06-09', 1, 'test', NULL, 1, 1, 1),
(2, '2019-06-09', '2019-06-09', 1, 'test', NULL, 1, 1, 1),
(3, '2019-06-09', '2019-06-09', 1, 'test', NULL, 1, 1, 1),
(4, '2019-06-09', '2019-06-09', 1, '   jm   ', '9jQD6ZHJ.png', 1, 2, 1),
(5, '2019-06-09', '2019-06-09', 1, 'test', 'zILp6MFo.png', 1, 1, 1),
(6, '2019-07-07', '2019-07-07', 1, 'clear', 'KVYwEvUm.png', 3, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `T_MedicineSchedule`
--

CREATE TABLE `T_MedicineSchedule` (
  `Id` int(11) NOT NULL,
  `MedicineDetailsId` int(11) NOT NULL,
  `PlannedSchedule` datetime NOT NULL,
  `ActualTaken` datetime NOT NULL,
  `NurseId` int(11) NOT NULL,
  `PatientId` int(11) NOT NULL,
  `DateUpdatedPatient` datetime NOT NULL,
  `Status` int(11) NOT NULL,
  `PatientRemarks` varchar(1500) NOT NULL,
  `NurseRemarks` varchar(1500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `T_MedicineSchedule`
--

INSERT INTO `T_MedicineSchedule` (`Id`, `MedicineDetailsId`, `PlannedSchedule`, `ActualTaken`, `NurseId`, `PatientId`, `DateUpdatedPatient`, `Status`, `PatientRemarks`, `NurseRemarks`) VALUES
(1, 5, '2019-07-18 15:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(2, 6, '2019-07-18 17:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(3, 4, '2019-07-18 19:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(4, 4, '2019-07-18 21:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(5, 4, '2019-07-18 23:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(6, 4, '2019-07-19 01:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(7, 4, '2019-07-19 03:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(8, 4, '2019-07-19 05:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(9, 4, '2019-07-19 07:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(10, 4, '2019-07-19 09:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(11, 4, '2019-07-19 11:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(12, 4, '2019-07-19 13:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(13, 4, '2019-07-19 15:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(14, 4, '2019-07-19 17:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(15, 4, '2019-07-19 19:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(16, 4, '2019-07-19 21:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(17, 4, '2019-07-19 23:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(18, 4, '2019-07-20 01:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(19, 4, '2019-07-20 03:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(20, 4, '2019-07-20 05:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(21, 4, '2019-07-20 07:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(22, 4, '2019-07-20 09:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(23, 4, '2019-07-20 11:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(24, 4, '2019-07-20 13:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(25, 4, '2019-07-20 15:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(26, 4, '2019-07-20 17:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(27, 4, '2019-07-20 19:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(28, 4, '2019-07-20 21:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(29, 4, '2019-07-20 23:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(30, 4, '2019-07-21 01:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(31, 4, '2019-07-21 03:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(32, 4, '2019-07-21 05:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(33, 4, '2019-07-21 07:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(34, 4, '2019-07-21 09:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(35, 4, '2019-07-21 11:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(36, 4, '2019-07-21 13:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(37, 4, '2019-07-21 15:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(38, 4, '2019-07-21 17:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(39, 4, '2019-07-21 19:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(40, 4, '2019-07-21 21:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(41, 4, '2019-07-21 23:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(42, 4, '2019-07-22 01:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(43, 4, '2019-07-22 03:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(44, 4, '2019-07-22 05:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(45, 4, '2019-07-22 07:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(46, 4, '2019-07-22 09:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(47, 4, '2019-07-22 11:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(48, 4, '2019-07-22 13:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(49, 4, '2019-07-22 15:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(50, 4, '2019-07-22 17:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(51, 4, '2019-07-22 19:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(52, 4, '2019-07-22 21:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(53, 4, '2019-07-22 23:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(54, 4, '2019-07-23 01:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(55, 4, '2019-07-23 03:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(56, 4, '2019-07-23 05:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(57, 4, '2019-07-23 07:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(58, 4, '2019-07-23 09:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(59, 4, '2019-07-23 11:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(60, 4, '2019-07-23 13:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(61, 4, '2019-07-23 15:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(62, 4, '2019-07-23 17:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(63, 4, '2019-07-23 19:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(64, 4, '2019-07-23 21:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(65, 4, '2019-07-23 23:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(66, 4, '2019-07-24 01:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(67, 4, '2019-07-24 03:26:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(379, 4, '2019-07-20 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(380, 4, '2019-07-20 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(381, 4, '2019-07-21 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(382, 4, '2019-07-21 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(383, 4, '2019-07-21 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(384, 4, '2019-07-21 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(385, 4, '2019-07-21 09:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(386, 4, '2019-07-21 11:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(387, 4, '2019-07-21 13:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(388, 4, '2019-07-21 15:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(389, 4, '2019-07-21 17:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(390, 4, '2019-07-21 19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(391, 4, '2019-07-21 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(392, 4, '2019-07-21 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(393, 4, '2019-07-22 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(394, 4, '2019-07-22 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(395, 4, '2019-07-22 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(396, 4, '2019-07-22 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(397, 4, '2019-07-22 09:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(398, 4, '2019-07-22 11:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(399, 4, '2019-07-22 13:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(400, 4, '2019-07-22 15:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(401, 4, '2019-07-22 17:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(402, 4, '2019-07-22 19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(403, 4, '2019-07-22 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(404, 4, '2019-07-22 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(405, 4, '2019-07-23 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(406, 4, '2019-07-23 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(407, 4, '2019-07-23 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(408, 4, '2019-07-23 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(409, 4, '2019-07-23 09:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(410, 4, '2019-07-23 11:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(411, 4, '2019-07-23 13:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(412, 4, '2019-07-23 15:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(413, 4, '2019-07-23 17:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(414, 4, '2019-07-23 19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(415, 4, '2019-07-23 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(416, 4, '2019-07-23 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(417, 4, '2019-07-24 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(418, 4, '2019-07-24 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(419, 4, '2019-07-24 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(420, 4, '2019-07-24 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(421, 4, '2019-07-24 09:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(422, 4, '2019-07-24 11:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(423, 4, '2019-07-24 13:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(424, 4, '2019-07-24 15:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(425, 4, '2019-07-24 17:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(426, 4, '2019-07-24 19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(427, 4, '2019-07-24 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(428, 4, '2019-07-24 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(429, 4, '2019-07-25 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(430, 4, '2019-07-25 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(431, 4, '2019-07-25 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(432, 4, '2019-07-25 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(433, 4, '2019-07-25 09:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(434, 4, '2019-07-25 11:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(435, 4, '2019-07-25 13:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(436, 4, '2019-07-25 15:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(437, 4, '2019-07-25 17:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(438, 4, '2019-07-25 19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(439, 4, '2019-07-25 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(440, 4, '2019-07-25 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(441, 4, '2019-07-26 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(442, 4, '2019-07-26 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(443, 4, '2019-07-26 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(444, 4, '2019-07-26 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(445, 4, '2019-07-26 09:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(446, 4, '2019-07-26 11:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(447, 4, '2019-07-26 13:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(448, 4, '2019-07-26 15:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(449, 4, '2019-07-26 17:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(450, 4, '2019-07-26 19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(451, 4, '2019-07-26 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(452, 4, '2019-07-26 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(453, 4, '2019-07-27 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(454, 4, '2019-07-27 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(455, 4, '2019-07-27 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(456, 4, '2019-07-27 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(457, 4, '2019-07-27 09:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(458, 4, '2019-07-27 11:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(459, 4, '2019-07-27 13:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(460, 4, '2019-07-27 15:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(461, 4, '2019-07-27 17:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(462, 4, '2019-07-27 19:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(463, 4, '2019-07-27 21:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(464, 4, '2019-07-27 23:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(465, 4, '2019-07-28 01:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(466, 4, '2019-07-28 03:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(467, 4, '2019-07-28 05:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(468, 4, '2019-07-28 07:32:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(469, 4, '2019-07-25 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(470, 4, '2019-07-25 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(471, 4, '2019-07-25 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(472, 4, '2019-07-25 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(473, 4, '2019-07-25 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(474, 4, '2019-07-25 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(475, 4, '2019-07-25 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(476, 4, '2019-07-25 14:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(477, 4, '2019-07-25 16:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(478, 4, '2019-07-25 18:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(479, 4, '2019-07-25 20:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(480, 4, '2019-07-25 22:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(481, 4, '2019-07-26 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(482, 4, '2019-07-26 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(483, 4, '2019-07-26 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(484, 4, '2019-07-26 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(485, 4, '2019-07-26 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(486, 4, '2019-07-26 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(487, 4, '2019-07-26 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(488, 4, '2019-07-26 14:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(489, 4, '2019-07-26 16:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(490, 4, '2019-07-26 18:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(491, 4, '2019-07-26 20:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(492, 4, '2019-07-26 22:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(493, 4, '2019-07-27 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(494, 4, '2019-07-27 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(495, 4, '2019-07-27 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(496, 4, '2019-07-27 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(497, 4, '2019-07-27 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(498, 4, '2019-07-27 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(499, 4, '2019-07-27 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(500, 4, '2019-07-27 14:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(501, 4, '2019-07-27 16:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(502, 4, '2019-07-27 18:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(503, 4, '2019-07-27 20:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(504, 4, '2019-07-27 22:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(505, 4, '2019-07-28 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(506, 4, '2019-07-28 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(507, 4, '2019-07-28 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(508, 4, '2019-07-28 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(509, 4, '2019-07-28 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(510, 4, '2019-07-28 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(511, 4, '2019-07-28 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(512, 4, '2019-07-28 14:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(513, 4, '2019-07-28 16:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(514, 4, '2019-07-28 18:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(515, 4, '2019-07-28 20:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(516, 4, '2019-07-28 22:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(517, 4, '2019-07-29 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(518, 4, '2019-07-29 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(519, 4, '2019-07-29 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(520, 4, '2019-07-29 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(521, 4, '2019-07-29 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(522, 4, '2019-07-29 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(523, 4, '2019-07-29 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(524, 4, '2019-07-29 14:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(525, 4, '2019-07-29 16:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(526, 4, '2019-07-29 18:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(527, 4, '2019-07-29 20:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(528, 4, '2019-07-29 22:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(529, 4, '2019-07-30 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(530, 4, '2019-07-30 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(531, 4, '2019-07-30 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', '');
INSERT INTO `T_MedicineSchedule` (`Id`, `MedicineDetailsId`, `PlannedSchedule`, `ActualTaken`, `NurseId`, `PatientId`, `DateUpdatedPatient`, `Status`, `PatientRemarks`, `NurseRemarks`) VALUES
(532, 4, '2019-07-30 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(533, 4, '2019-07-30 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(534, 4, '2019-07-30 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(535, 4, '2019-07-30 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(536, 4, '2019-07-30 14:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(537, 4, '2019-07-30 16:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(538, 4, '2019-07-30 18:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(539, 4, '2019-07-30 20:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(540, 4, '2019-07-30 22:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(541, 4, '2019-07-31 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(542, 4, '2019-07-31 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(543, 4, '2019-07-31 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(544, 4, '2019-07-31 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(545, 4, '2019-07-31 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(546, 4, '2019-07-31 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(547, 4, '2019-07-31 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(548, 4, '2019-07-31 14:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(549, 4, '2019-07-31 16:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(550, 4, '2019-07-31 18:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(551, 6, '2019-07-18 20:13:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(552, 4, '2019-07-18 19:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(553, 4, '2019-08-01 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(554, 4, '2019-08-01 02:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(555, 4, '2019-08-01 04:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(556, 4, '2019-08-01 06:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(557, 4, '2019-08-01 08:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(558, 4, '2019-08-01 10:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', ''),
(559, 4, '2019-08-01 12:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `T_NurseActivity`
--

CREATE TABLE `T_NurseActivity` (
  `Id` int(11) NOT NULL,
  `ActivityDetails` varchar(2500) NOT NULL,
  `EngagementDetailsId` int(11) NOT NULL,
  `NurseId` int(11) NOT NULL,
...
--
-- Dumping data for table `T_NurseActivity`
--

INSERT INTO `T_NurseActivity` (`Id`, `ActivityDetails`, `EngagementDetailsId`, `NurseId`, `DateCreated`) VALUES
(1, 'test', 20, 3, '2019-07-07 05:29:00'),
(2, 'test', 23, 3, '2019-07-07 05:34:00'),
(3, 'provided 500mg paracetamol', 23, 3, '2019-07-07 05:39:00'),
(4, 'test data', 23, 3, '2019-07-07 06:04:00'),
(5, 'provide 500mg paracetamol', 24, 3, '2019-07-07 07:53:00'),
(6, 'provided 500mg paracetamol', 24, 3, '2019-07-07 08:02:00');
...
--
-- Indexes for table `R_ChiefComplaint`
--
ALTER TABLE `R_ChiefComplaint`
  ADD PRIMARY KEY (`Id`);
...
--
-- Indexes for table `R_Disposition`
--
ALTER TABLE `R_Disposition`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `R_Doctor`
--
ALTER TABLE `R_Doctor`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `R_LaboratoryCategory`
--
ALTER TABLE `R_LaboratoryCategory`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `R_Medicine`
--
ALTER TABLE `R_Medicine`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `R_Patient`
--
ALTER TABLE `R_Patient`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `R_Province`
--
ALTER TABLE `R_Province`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `R_Purpose`
--
ALTER TABLE `R_Purpose`
  ADD PRIMARY KEY (`Id`);
...
--
-- Indexes for table `R_Specialization`
--
ALTER TABLE `R_Specialization`
  ADD PRIMARY KEY (`Id`);
...
--
-- Indexes for table `T_Allergies`
--
ALTER TABLE `T_Allergies`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `T_Engagement`
--
ALTER TABLE `T_Engagement`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `T_EngagementDetails`
--
ALTER TABLE `T_EngagementDetails`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `T_EngagementDetailsDoctor`
--
ALTER TABLE `T_EngagementDetailsDoctor`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `T_EngagementMedicine`
--
ALTER TABLE `T_EngagementMedicine`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `T_LaboratoryResult`
--
ALTER TABLE `T_LaboratoryResult`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `T_MedicineSchedule`
--
ALTER TABLE `T_MedicineSchedule`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `T_NurseActivity`
--
ALTER TABLE `T_NurseActivity`
  ADD PRIMARY KEY (`Id`);
...
--
-- AUTO_INCREMENT for table `R_ChiefComplaint`
--
ALTER TABLE `R_ChiefComplaint`
...
--
-- AUTO_INCREMENT for table `R_Disposition`
--
ALTER TABLE `R_Disposition`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `R_Doctor`
--
ALTER TABLE `R_Doctor`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `R_LaboratoryCategory`
--
ALTER TABLE `R_LaboratoryCategory`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `R_Medicine`
--
ALTER TABLE `R_Medicine`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `R_Patient`
--
ALTER TABLE `R_Patient`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `R_Province`
--
ALTER TABLE `R_Province`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT for table `R_Purpose`
--
ALTER TABLE `R_Purpose`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `R_Specialization`
--
ALTER TABLE `R_Specialization`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `T_Allergies`
--
ALTER TABLE `T_Allergies`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `T_Engagement`
--
ALTER TABLE `T_Engagement`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `T_EngagementDetails`
--
ALTER TABLE `T_EngagementDetails`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `T_EngagementDetailsDoctor`
--
ALTER TABLE `T_EngagementDetailsDoctor`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `T_EngagementMedicine`
--
ALTER TABLE `T_EngagementMedicine`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `T_LaboratoryResult`
--
ALTER TABLE `T_LaboratoryResult`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `T_MedicineSchedule`
--
ALTER TABLE `T_MedicineSchedule`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=560;

--
-- AUTO_INCREMENT for table `T_NurseActivity`
--
ALTER TABLE `T_NurseActivity`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
